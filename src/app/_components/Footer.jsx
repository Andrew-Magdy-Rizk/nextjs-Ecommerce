...
function Footer() {
 ...
 <div className={modeState && "dark"}>
    <footer className="w-full bg-gray-50 dark:bg-neutral-800">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* <!--Grid--> */}
        <div className="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
            <div className="col-span-full xl:col-span-3 relative bg-gradient-to-tr from-secondary to-primary rounded-2xl gap-12 p-6 xl:w-72 h-96 flex flex-col justify-center items-center">
                
                <Image src="/logo.svg" alt="Logo" width={100} height={100} />
                <p className="text-center text-gray-600">Trusted in more than 100 countries & 5 million customers.
                        ...
                        <svg className="w-[1rem] h-[1rem]" viewBox="0 0 13 12" fill="none"
                            ...
                            <defs>
                                <linearGradient id="paint0_linear_9147_19261" x1="12.6124" y1="0.699364"
                                    ...
                                    <stop className='bg-white' />
                                    <stop offset="0.993738" className='bg-white'  />
                                </linearGradient>
                            </defs>
                        </svg>
            ...
            <div className="block text-center xl:text-left xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
                <h4 className="text-lg text-gray-900 font-bold mb-9 dark:text-white">Get In Touch</h4>
                <ul className="text-gray-900 transition-all duration-500 grid gap-6 dark:text-white">
                    <li>andrewdakran72@Gmail.com</li>
                    <li>+20 127 598 0639</li>
                    <li>Almasala, Fayoum, Egypt</li>
                </ul>
            </div>
            <div className="block xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3">
                <h4 className="text-lg text-gray-900 font-bold mb-9 text-center xl:text-left dark:text-white">Quick Links</h4>
                <div className="flex gap-6 xl:gap-12 max-xl:justify-center">
                    <ul className="text-gray-600 transition-all duration-500 grid gap-6 dark:text-neutral-300">
                        <li><a href="#">Home</a></li>
                        <li><a href="#">FAQs</a></li>
            ...
            <div className="block xl:py-16 col-span-full md:col-span-4 xl:col-span-3">
                <h4 className="text-lg text-gray-900 font-bold mb-9 text-center xl:text-left dark:text-white">Newsletter</h4>
                <div className="grid gap-7 ">
                    <input type="text" name="email"
                        className="py-2 px-4 border border-gray-300 shadow-sm h-14 text-lg text-gray-800 rounded-full w-full  xl:w-64 placeholder:text-gray-400 focus:outline-none dark:text-white"
                        placeholder="Enter email.." />
                    <button type="submit"
                        className="flex gap-2 justify-center items-center py-3.5 px-7 rounded-full text-black bg-primary shadow-md w-fit transition-all duration-500 mx-auto xl:mx-0 hover:bg-secondary">Subscribe<svg
    ...
    <div className="py-4 bg-gradient-to-tr from-gray-400 to-gray-300 dark:from-neutral-600 dark:to-neutral-800">
        <div className="flex items-center justify-center">
            <span className="text-sm text-gray-800 dark:text-white ">Copyright@2024 All Right Reserved  by <a href="https://pagedone.io/">pagedone</a></span>
        </div>
    </div>
</footer>
 </div>
